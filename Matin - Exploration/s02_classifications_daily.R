...
# Mobility -----------------------------------------------------------------
classification.df <- daily.df[, c(1:7)]
classification.df$class.var <- daily.df$class.mobilityImpaired
...
classification.df$class.var <- daily.df$class.cognitionImpaired
...
classification.df$class.var <- daily.df$class.cvd
