...
# Mobility -----------------------------------------------------------------
classification.df <- time.of.day.df[, c(1:25)]
classification.df[is.na(classification.df)] <- 0
classification.df$class.var <- time.of.day.df$class.mobilityImpaired
...
classification.df$class.var <- time.of.day.df$class.cognitionImpaired
...
classification.df$class.var <- time.of.day.df$class.cvd
